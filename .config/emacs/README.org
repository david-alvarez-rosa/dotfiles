...
Utility to cycle between flyspell on English, flyspell on Spanish,
flyspell off.
#+begin_src elisp
...
*** Ripgreg
Prefer =ripgrep= for searching over =rgrep=
#+begin_src elisp
...
Configure vterm with ~projectile.el~
#+begin_src elisp
...
Configure PlantUML with Org babel.
#+begin_src elisp
