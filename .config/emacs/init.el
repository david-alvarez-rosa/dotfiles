...
(defun dalvrosa/project-vterm (&optional opencode new)
  "Open a vterm in the current project root.
With NEW (prefix arg), always create a new buffer.
With OPENCODE, use the \"vterm-opencode\" base name."
...
(defun dalvrosa/project-vterm-opencode (&optional new)
...
(with-eval-after-load 'project
  ...
  (keymap-set project-prefix-map "h" 'dalvrosa/project-vterm-opencode)
