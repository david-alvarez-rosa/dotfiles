...
(setq org-agenda-custom-commands
      '((" " "Block Agenda"
         ((agenda "" ((org-agenda-span 1)))
          ...
          (tags-todo "TODO=\"TODO\"-work-blog-unwall-backlog" ((org-agenda-overriding-header "Standalone")
                                                   (org-agenda-skip-function '(org-agenda-skip-entry-if 'scheduled))))
          (tags-todo "TODO=\"TODO\"+unwall-backlog" ((org-agenda-overriding-header "Unwall")
                                                   (org-agenda-skip-function '(org-agenda-skip-entry-if 'scheduled))))
