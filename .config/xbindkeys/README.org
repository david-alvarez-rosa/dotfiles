...
#+begin_src conf
  "maim | tee ~/media/screenshots/$(date +'%Y%m%d-%H:%M:%S').png | xclip -selection clipboard -t image/png"
    Print
  "maim --window ~/media/screenshots/$(xdotool getactivewindow) | tee $(date +'%Y%m%d-%H:%M:%S').png | xclip -selection clipboard -t image/png"
    Shift + Print
  "maim --select | tee ~/media/screenshots/$(date +'%Y%m%d-%H:%M:%S').png | xclip -selection clipboard -t image/png"
    Control + Print
#+end_src
