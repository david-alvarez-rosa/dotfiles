...
#+BEGIN_SRC emacs-lisp
  (setq org-capture-templates
        '(("t" "Algo pendiente por hacer." entry
           ...
           "* TODO [#C] %?\nSCHEDULED: %t" :empty-lines-before 1 :empty-lines-after 2)
          ("l" "Algo pendiente por hacer (con link)." entry
           (file+headline "/home/david/Documents/Notas.org" "Pendiente")
           "* TODO [#C] %?\nSCHEDULED: %t\n%a" :empty-lines-before 1 :empty-lines-after 2)
          ("u" "Algo pendiente para universidad." entry
           (file "/home/david/Documents/UPC/Cuatrimestre 9/UPC.org")
           "* TODO [#C] %?\nSCHEDULED: %t" :empty-lines-after 0)))
#+END_SRC
