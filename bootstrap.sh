...
systemctl --user enable keepassxc.service mbsync.timer commit-docs.timer imapnotify@personal.service imapnotify@spam.service systemd-tmpfiles-setup.service
